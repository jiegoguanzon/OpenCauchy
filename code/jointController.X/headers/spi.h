...
void spi_init () {
    ...
    SPI1CON1Lbits.CKE = 1;      // Transmit happens on falling edge
    ...
    SPI1CON1Lbits.DISSDI = 1;   // SDI1 pin is controlled by module
    SPI1CON1Lbits.DISSCK = 1;   // SCLK1 pin is controlled by module
